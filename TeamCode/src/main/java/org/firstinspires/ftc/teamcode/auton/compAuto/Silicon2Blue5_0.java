...
@Config
@Autonomous(name = "Silicon2Blue5_0", group = "Autonomous", preselectTeleOp = "TeleopV2")
public class Silicon2Blue5_0 extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        double wallOffset = Robot.CompFieldOffsets.Silicon2Blue - 0.5;
