...
@Config
@Autonomous(name = "SweepySpeci5_0  ", group = "Autonomous", preselectTeleOp = "TeleopV2")
public class SweepySpeci5_0 extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        Action driveAction = drive.actionBuilder(beginPose)
                ...
                .afterTime(1.25, q.autoSamplePickup2())
                .splineToSplineHeading(new Pose2d(-29.97,42.09, Math.toRadians(-145.5)), Math.toRadians(180))
                ...
                .afterTime(0, q.grippyOpen())
                .splineToSplineHeading(new Pose2d(-40.42, 42.65, Math.toRadians(-146.44)), Math.toRadians(270))
                ...
                .splineToSplineHeading(new Pose2d(-49.02, 41.67, Math.toRadians(-151.7)), Math.toRadians(270))
