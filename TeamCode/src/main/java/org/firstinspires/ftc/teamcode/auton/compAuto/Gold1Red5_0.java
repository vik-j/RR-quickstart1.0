...
@Config
@Autonomous(name = "Gold1Red5_0", group = "Autonomous", preselectTeleOp = "TeleopV2")
public class Gold1Red5_0 extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        double wallOffset = Robot.CompFieldOffsets.Gold1Red - 0.5;
