...
@Config
public final class BasketSideMecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.0014427894646087134;
        public double trackWidthTicks = 6392.83049436705;
        // 94.85642530934355

        // feedforward parameters (in tick units)
        public double kS = 0.9178134734808197;
        public double kV = 0.000242;
    ...
    public static List<Double> motorPowers = new ArrayList<>();
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(BasketSideMecanumDrive.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(BasketSideMecanumDrive.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(BasketSideMecanumDrive.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(BasketSideMecanumDrive.this.rightFront));
    ...
    public BasketSideMecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
