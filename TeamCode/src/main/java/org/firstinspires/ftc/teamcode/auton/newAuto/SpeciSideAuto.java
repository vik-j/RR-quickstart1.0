...
public class SpeciSideAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                .splineToConstantHeading(new Vector2d(-6, 40), Math.toRadians(270));// -8, -45
//                .waitSeconds(1.5)
...
//                .strafeToLinearHeading(new Vector2d(42,-56), Math.toRadians(270));
        ...
        Action waitAndArm = drive.actionBuilder(initialPose)
                .afterTime(0.01, bot.setPidVals(1950,800))// 1050, 3800 arm out
...
//                })
        ...
        Actions.runBlocking(bot.setPidVals(1100, 0));
