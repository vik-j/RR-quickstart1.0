...
@Config
@Autonomous(name = "Gold2Red5_0", group = "Autonomous", preselectTeleOp = "TeleopV2")
public class Gold2Red5_0 extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        double wallOffset = Robot.CompFieldOffsets.Gold2Red - 0.5;
